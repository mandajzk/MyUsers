...
- __User Level Support__ - _Done, this has been added now_<br>Adding the restrictions needed to display or not certain pages or content based on user level. Will be updating the demo shortly to only show the "Manage Users" option to admin level users.
...
- __Multiple Demos__ - _standalone CP is complete_ [view demo] (http://myusers-cp.redhousewd.com/)<br>3 Demos based on their application like a standalone CP or a community driven site.
